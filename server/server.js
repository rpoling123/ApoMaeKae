...
const LATEST_VERSION="9.2.3";const PORT=Number(process.env.PORT||8080),TOKEN=process.env.ADMIN_TOKEN||"ApoMaeKae_Admin_2026_X7k9",PAYMENT_SECRET=process.env.PAYMENT_WEBHOOK_SECRET||"";
